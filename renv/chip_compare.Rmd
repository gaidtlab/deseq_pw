...
source(paste0(install_dir,"/deseq2.plot.R"))
source(paste0(install_dir,"/multiple_matrix_DESeq2.functions.R"))  # mPCA
source(paste0(install_dir,"/analyse.functions.R"))  # write_extended_results_table
```
