...
install_dir <- Sys.getenv("DESEQ_PW_INSTALL_DIR", unset = "/groups/gaidt/bioinf/software/scripts/deseq_pw")

source(paste0(install_dir,"/renv/deseq2.plot.R"))
source(paste0(install_dir,"/renv/multiple_matrix_DESeq2.functions.R"))  # mPCA
source(paste0(install_dir,"/renv/analyse.functions.R"))  # write_extended_results_table
```
...
params=list(
  sampleTable='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/ChIP/ChIP_R19299_ChIPSeq2_LK/Differential_analysis/DeSeq/ChIP_ATAC_pairwise/deseq_pw_MORC3/samples_experiment.txt',
  #sampleTable='/users/jaritz/Gaidt/bioinf/software/scripts/deseq_pw/samples_experiment.txt',
  conditions_colname='condition',
  control_condition='exp1',
  experiment_condition='exp2',
  countTableAnnot='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/ChIP/ChIP_R19299_ChIPSeq2_LK/Differential_analysis/DeSeq/ChIP_ATAC_pairwise/deseq_pw_MORC3/results/featureCount_concat/featureCount_counts.annot.txt',
  countTable='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/ChIP/ChIP_R19299_ChIPSeq2_LK/Differential_analysis/DeSeq/ChIP_ATAC_pairwise/deseq_pw_MORC3/results/featureCount_concat/featureCount_counts.txt',
  odir=odir,
  downsample_pairs=1000,
  downsample_ma=0,
...
params=list(
  sampleTable='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/DeSeq/ChIP_ATAC_pairwise/deseq_pw_PU1/samples_experiment.txt',
  conditions_colname='condition',
  control_condition='exp1',
  experiment_condition='exp2',
  countTableAnnot='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/DeSeq/ChIP_ATAC_pairwise/deseq_pw_PU1/results/featureCount_concat/featureCount_counts.annot.txt',
  countTable='/groups/gaidt/user/luisa.krumwiede/01-BioInfo_Storage/DeSeq/ChIP_ATAC_pairwise/deseq_pw_PU1/results/featureCount_concat/featureCount_counts.txt',
  odir=odir,
  downsample_pairs=1000,
  downsample_ma=0,
  session="http://localhost:60151/goto?",
...
# make sure that the order of samples is correct
m <- m %>% arrange(sample_name)
...
save(cts.norm.sub,file=paste0(params$odir,"/norm_counts.RData"))
